...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() Тогда
		ПересчитатьКоличествоОстатков(ЭтотОбъект);
...
Процедура ТоварыПАТПриИзменении(Элемент)
	...
	ПересчитатьКоличествоОстатков(ЭтотОбъект, Элементы.Товары.ТекущаяСтрока);
...
Процедура ПерезаполнитьОстатки(Команда)
	...
	ПересчитатьКоличествоОстатков(ЭтотОбъект, Элементы.Товары.ВыделенныеСтроки);
...
&НаКлиентеНаСервереБезКонтекста
Процедура ПересчитатьКоличествоОстатков(Форма, СтрокиДляЗаполнения = Неопределено)
	...
	Для Индекс = 0 По МассивСтрок.Количество() - 1 Цикл
		...
		ПересчитатьКоличествоУпаковокОстатков(Строка);
	КонецЦикла;
