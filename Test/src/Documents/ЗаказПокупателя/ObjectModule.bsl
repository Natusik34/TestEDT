...
Процедура АссистентУправленияПриСрабатыванииСобытия()
	...
	СтрокиОплатыБонусами = Предоплата.НайтиСтроки(Новый Структура("ОплатаБонусами", Истина));
	Списано = Предоплата.Выгрузить(СтрокиОплатыБонусами, "СуммаРасчетов").Итог("СуммаРасчетов");
	...
	ПараметрыСообщения.Вставить("Начислено", 0);
