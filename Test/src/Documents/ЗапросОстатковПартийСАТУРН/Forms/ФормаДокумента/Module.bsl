...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ИнтеграцияСАТУРН.ЗаполнитьСопоставленныеТовары(Объект.ОстаткиПоДаннымСАТУРН, НоменклатураДляВыбора);
...
Процедура УстановитьУсловноеОформление()
	...
	ИнтеграцияСАТУРН.УстановитьУсловноеОформлениеПоляНоменклатура(
		ЭтотОбъект, "ОстаткиПоДаннымСАТУРННоменклатура", "ОстаткиПоДаннымСАТУРН");
	ИнтеграцияСАТУРН.УстановитьУсловноеОформлениеПоляХарактеристика(
		ЭтотОбъект, "ОстаткиПоДаннымСАТУРНХарактеристика", "ОстаткиПоДаннымСАТУРН");
