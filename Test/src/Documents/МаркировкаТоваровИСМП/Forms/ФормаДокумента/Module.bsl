...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Элементы.ТоварыСертификация.АвтоОтметкаНезаполненного = ТребуетсяУказаниеСертификации(ВидПродукции, ОперацииМаркировки);
	
	Элементы.Сертификация.Видимость                 = ОтчетПроизводственнойЛинии И (ЭтоВводВОборот И Не ЭтоИмпортСФТС Или ЭтоМаркировкаОстатков);
	Элементы.Сертификация.АвтоОтметкаНезаполненного = ОтчетПроизводственнойЛинии И ТребуетсяУказаниеСертификации(ВидПродукции, ОперацииМаркировки);
