...
// Устарела: больше не используется.
// Установить свойства элемента управления для мобильного приложения.
//
// Параметры:
...
Процедура СохранитьMACАдресДляРабочееМеста(MACАдрес) Экспорт
	...
	Если ЗначениеЗаполнено(РабочееМестоКлиента) И (РабочееМестоКлиента.MACАдрес <> MACАдрес)Тогда
