...
//  Булево
//
Функция НуженФорматноЛогическийКонтроль(ДанныеЧека) Экспорт
	...
	Если (НЕ ЗначениеЗаполнено(ДанныеЧека.СпособФорматноЛогическогоКонтроля))
		ИЛИ ДанныеЧека.СпособФорматноЛогическогоКонтроля = Перечисления.СпособыФорматноЛогическогоКонтроля.НеКонтролировать Тогда
		Возврат Ложь;
	КонецЕсли;
...
Процедура ПровестиФорматноЛогическийКонтроль(ДанныеЧека, ИдентификаторУстройства = Неопределено) Экспорт
	...
	Если Не НуженФорматноЛогическийКонтроль(ДанныеЧека) Тогда
		Возврат;
	КонецЕсли;
