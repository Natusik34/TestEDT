...
Функция ПолучитьХарактеристикиКатегорииВФоне(
	...
	Если ЗначениеЗаполнено(Контрагенты) Тогда
		...
		ИдентификаторыКонтрагентов = БизнесСеть.ИдентификаторыКонтрагентов(Контрагенты);
...
Процедура ДополнитьЗапросСлужебнымиТаблицами(Запрос)
	...
	|СГРУППИРОВАТЬ ПО
	|	ТоварыСлужебный.ПрайсЛист,
	|	ТоварыСлужебный.Организация,
	|	ТоварыСлужебный.Номенклатура,
	|	ТоварыСлужебный.НаименованиеНоменклатуры,
	|	ТоварыСлужебный.Характеристика,
	|	ТоварыСлужебный.НаименованиеХарактеристики,
	|	ТоварыСлужебный.Артикул,
	|	ТоварыСлужебный.ОписаниеНоменклатуры,
	|	ТоварыСлужебный.ЕдиницаИзмерения,
	|	ТоварыСлужебный.Упаковка,
	|	ТоварыСлужебный.НаименованиеУпаковки,
	|	ТоварыСлужебный.ЧислительУпаковки,
	|	ТоварыСлужебный.ЗнаменательУпаковки,
	|	ТоварыСлужебный.КратностьУпаковки,
	|	ТоварыСлужебный.СтавкаНДС,
	|	ТоварыСлужебный.ЦенаВключаетНДС,
	|	ТоварыСлужебный.ПричинаИсключенияИзПубликации,
	|	ТоварыСлужебный.ТекущаяПричинаИсключенияИзПубликации,
	|	ТоварыСлужебный.ТекущееСостояниеПубликацииТорговыхПредложений,
	|	ТоварыСлужебный.Цена,
	|	ТоварыСлужебный.СрокПоставки,
	|	ТоварыСлужебный.ВариантПубликацииОстатков,
	|	ТоварыСлужебный.Наличие,
	|	ТоварыСлужебный.Количество,
	|	ТоварыСлужебный.ВидНоменклатуры,
	|	ТоварыСлужебный.Родитель,
	|	ТоварыСлужебный.ОбъектСопоставления,
	|	ТоварыСлужебный.ИдентификаторКатегории,
	|	ТоварыСлужебный.КатегорияНаименование,
	|	ТоварыСлужебный.ПредставлениеНоменклатурыСервиса,
	|	ТоварыСлужебный.ИдентификаторНоменклатурыСервиса,
	|	ТоварыСлужебный.ПредставлениеХарактеристикиСервиса,
	|	ТоварыСлужебный.ИдентификаторХарактеристикиСервиса,
	|	ТоварыСлужебный.ИдентификаторНоменклатуры,
	|	ТоварыСлужебный.ИдентификаторПредложения,
	|	ТоварыСлужебный.ХешНоменклатуры,
	|	ТоварыСлужебный.ХешПредложения,
	|	ТоварыСлужебный.ХешНоменклатурыПредложения,
	|	ТоварыСлужебный.ИдентификаторПрайсЛиста,
	|	ТоварыСлужебный.Публикуется,
	|	ТоварыСлужебный.ОтключитьПубликацию,
	|	ТоварыСлужебный.Отключено,
	|	ТоварыСлужебный.ХешИзображений,
	|	ТоварыСлужебный.ХешИзображенийПредложения";
