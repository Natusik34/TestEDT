...
Функция ТипИзвещенияДляЭлементаРегламента(ТипЭлементаРегламента, ПараметрыДокумента, ЭтоВходящийЭДО = Ложь) Экспорт
	...
	Если ЭтоВнутреннийОбмен(ПараметрыДокумента.СпособОбмена) Или 
		(ЭтоИнформацияУчастникаЭДО(ТипЭлементаРегламента) И Не ПараметрыДокумента.ТребуетсяИзвещение) Тогда
		Возврат Результат;
	КонецЕсли;
