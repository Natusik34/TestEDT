...
// * ИдентификаторЗапросаГИСМТ        - ОпределяемыйТип.УникальныйИдентификаторИС, Неопределено             - Идентификатор запроса ГИС МТ
// * ДатаВремяПолученияИдентификатора - Дата, Неопределено                                                  - Дата получения идентификатора ГИС МТ
Функция НовыйЭлементКоллекцииУпаковокДляРаспределенияПоТоварам() Экспорт
	...
	ВозвращаемоеЗначение.Вставить("ИдентификаторЗапросаГИСМТ",        Неопределено);
	ВозвращаемоеЗначение.Вставить("ДатаВремяПолученияИдентификатора", Неопределено);
...
Функция РаспределениеШтрихкодовУпаковокПоТоварам(ПараметрыРаспределения, Товары, МассивУпаковок) Экспорт
	...
	СвойстваЗаполнения = "Штрихкод,ВидПродукции,ВидУпаковки,ПолныйКодМаркировки,СоставКодаМаркировки,
			             |ШтрихкодУпаковки,ТипШтрихкода,КоличествоПотребительскихУпаковок,ИдентификаторЗапросаГИСМТ,ДатаВремяПолученияИдентификатора";
...
// * ИдентификаторЗапросаГИСМТ         - ОпределяемыйТип.УникальныйИдентификаторИС - идентификатор запроса ГИС МТ
...
Функция НовыйРезультатРаспределенияШтрихкодовПоТоварам()
	...
	ВозвращаемоеЗначение.Вставить("ДатаВремяПолученияИдентификатора",  Дата(1,1,1));
