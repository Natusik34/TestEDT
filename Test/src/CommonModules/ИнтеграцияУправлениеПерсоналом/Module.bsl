...
//
Функция ОбъектыДляРегистрацииОбмена(Приложение, ДанныеДляРегистрации) Экспорт
...
Процедура СохранитьНовыеВидыКонтактнойИнформации(ВидКИМобильныйТелефон, ВидКИАдресЭлектроннойПочты, СообщениеОбОшибке) Экспорт
	...
	РегистрироватьУправлениеПерсоналом.Колонки.Добавить("ТипОбъекта", 	Новый ОписаниеТипов("ПеречислениеСсылка.ТипыОбъектовИнтеграцияУправлениеПерсоналом"));
	...
	РегистрироватьКабинетСотрудника.Колонки.Добавить("ТипОбъекта", 	Новый ОписаниеТипов("ПеречислениеСсылка.ТипыОбъектовИнтеграцияУправлениеПерсоналом"));
...
Функция ТипыОбъектовВыгружаемыхПоПравилам(Приложение) Экспорт
	
	ПеречисленияМенеджер = Перечисления.ТипыОбъектовИнтеграцияУправлениеПерсоналом;
	
	// Порядок элементов в массиве определяет порядок выгрузки объектов.
	ТипыОбъектов = Новый Массив;
	ТипыОбъектов.Добавить(ПеречисленияМенеджер.ФизическоеЛицо);
	ТипыОбъектов.Добавить(ПеречисленияМенеджер.Организация);
	ТипыОбъектов.Добавить(ПеречисленияМенеджер.Подразделение);
	ТипыОбъектов.Добавить(ПеречисленияМенеджер.Должность);
	ТипыОбъектов.Добавить(ПеречисленияМенеджер.ДолжностьПоШтатномуРасписанию);
	ТипыОбъектов.Добавить(ПеречисленияМенеджер.Сотрудник);
	ТипыОбъектов.Добавить(ПеречисленияМенеджер.ГрафикРаботы);
