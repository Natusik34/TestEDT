...
Функция ПараметрыКодаМаркировки(ЭлементДанных = Неопределено, ВидПродукции = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Иначе
		...
		ДанныеЧастичногоВыбытия = Новый Структура("ЕмкостьПотребительскойУпаковки, ЧастичноеВыбытиеВыведено, ЕстьДанныеЧастичногоВыбытия", 
			0, 0, Ложь);
		...
		Если ДанныеЧастичногоВыбытия.ЕстьДанныеЧастичногоВыбытия Тогда
			...
			ПараметрыКодаМаркировки.ЧастичноеВыбытиеОстаток        = ПараметрыКодаМаркировки.ЕмкостьПотребительскойУпаковки - ПараметрыКодаМаркировки.ЧастичноеВыбытиеВыведено;
...
Функция ИнициализироватьПараметрыКодаМаркировки()
	...
	ПараметрыКодаМаркировки.Вставить("ИдентификаторЗапросаГИСМТ");
	ПараметрыКодаМаркировки.Вставить("ДатаВремяПолученияИдентификатора");
