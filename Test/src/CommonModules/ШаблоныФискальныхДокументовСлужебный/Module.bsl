...
//
Процедура ВывестиШтрихкод(ТабличныйДокумент, Область, ТипШтрихкода, Знач Штрихкод) Экспорт
...
//   Данные - см. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека.
//   ФискальнаяОперация - Структура.
//   Параметры - см. ФискальныеДокументыВызовСервера.ПараметрыШаблонаФискальногоДокумента.
//
...
//   * Колонки - Массив из см. ПараметрыКолонкиЭлементаШаблона.
...
Функция НовыйЭлементШаблона()
	...
	Элемент.Вставить("Колонки", Новый Массив()); // Массив из см. ПараметрыКолонкиЭлементаШаблона
