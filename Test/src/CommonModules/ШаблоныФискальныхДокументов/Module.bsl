...
// Возвращаемое значение:
//   Структура - см. НовыйФормат.
Функция ФорматШтрихкод(Выравнивание = Неопределено, ШтрихкодТип = "EAN13", ШтрихкодВысота = 0) Экспорт
...
// Возвращаемое значение:
//   Структура - см. НовыйФормат
Функция ФорматШтрихкодШирина(Ширина, Выравнивание = Неопределено, ШтрихкодТип = "EAN13", ШтрихкодВысота = 0) Экспорт
...
Функция ВывестиКакТабличныйДокумент(Шаблон) Экспорт
	...
	Для Каждого Элемент Из Шаблон.Элементы Цикл
		...
		Для Каждого Картинка Из Элемент.Картинки Цикл
			...
			ШаблоныФискальныхДокументовСлужебный.ВывестиШтрихкод(ТабличныйДокумент, Область, Картинка.ШтрихкодТип, Картинка.Строка);
