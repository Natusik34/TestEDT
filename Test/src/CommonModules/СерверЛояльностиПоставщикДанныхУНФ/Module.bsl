...
Процедура ДополнитьСтруктуруСкидокМаксимальнойСуммойОплатыБаллами(СериализованнаяСтруктураСкидок, ТаблицаТовары, КартаКлиента)
	...
	Если ЗначениеЗаполнено(КартаКлиента)
		...
		СуммаОплаты = РаботаСБонусами.ПолучитьМаксимальнуюСуммуОплатыДокумента(ТаблицаТовары, КартаКлиента);
	КонецЕсли;
	СериализованнаяСтруктураСкидок.Вставить("MaxBonusPay", СуммаОплаты);
