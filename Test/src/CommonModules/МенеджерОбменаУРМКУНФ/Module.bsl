...
Процедура ПКО_Справочник_Подразделения_Отправка_ПриОтправкеДанных(ДанныеИБ, ДанныеXDTO, КомпонентыОбмена, СтекВыгрузки)
	...
	ЗаписатьПризнакиОбменУРМК(ДанныеXDTO, КомпонентыОбмена.УзелКорреспондента);
...
Процедура ЗаписатьПризнакиОбменУРМК(ДанныеXDTO, УзелСсылка)
	...
	AdditionalInfo = Новый Структура("ИспользоватьДисконтныеКарты, НеВыгружатьФизическихЛиц, ВыгружатьСерии",
		ИспользоватьДисконтныеКарты, НеВыгружатьФизическихЛиц, ВыгружатьСерии);
