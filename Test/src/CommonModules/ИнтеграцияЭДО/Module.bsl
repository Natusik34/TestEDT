...
// 
// Параметры:
//  ОбъектУчета - Неопределено - если объект учёта отсутствует
...
// 
// Параметры:
//  ДеревоЭД - СтрокаДереваЗначений: см. ДеревоЭлектронногоДокументаБЭД.ИнициализироватьДеревоРазбора
//  ДокументУчета - ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО
//  ДанныеДополнительногоТитула - См. ИнтеграцияЭДОКлиентСервер.НовыеДанныеДополнительногоТитулаДляОтраженияВУчете
