...
Процедура ИсключитьЗаписиСтарыхЦенИзТаблицы(ТаблицаНоменклатуры) Экспорт
	...
	|	ВнешняяТаблицаНоменклатуры.ВидЦен КАК ВидЦен,
	...
	Запрос.УстановитьПараметр("ВнешняяТаблицаНоменклатуры", ТаблицаНоменклатуры.Скопировать( , "ВидЦен,Номенклатура,Характеристика"));
