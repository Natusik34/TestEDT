...
Процедура ЗагрузитьОборотыОФД(Команда)
	...
	Если НЕ ТекущиеДанные = Неопределено Тогда
		...
		МенеджерОфлайнОборудованияКлиент.НачатьЗагрузкуОборотовИзОФД(ТекущиеДанные.Ссылка, УникальныйИдентификатор, Неопределено);
...
Процедура ЗагрузитьЧекиОФД(Команда)
	...
	Если НЕ ТекущиеДанные = Неопределено Тогда
		...
		МенеджерОфлайнОборудованияКлиент.НачатьЗагрузкуЧековИзОФД(ТекущиеДанные.Ссылка, УникальныйИдентификатор, Неопределено);
