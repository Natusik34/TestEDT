...
Функция СформироватьИтоговыйРезультатПоИтогамОтдельныхПроверок(ПараметрыОбработки)
	...
	Если ПроверкиСОшибкамиПроцесса.Количество() > 0 Тогда
		...
		ИдентификаторыПредупреждений = Новый Соответствие;
		...
		Для Каждого ИдентификаторПроверки Из ПроверкиСОшибкамиПроцесса Цикл
			...
			Если ИдентификаторыПредупреждений[ИдентификаторПроверки] = Неопределено И ИдентификаторПроверкиСОшибкой = Неопределено
