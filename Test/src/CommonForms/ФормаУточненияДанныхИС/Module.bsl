...
Процедура ЗакрытьФорму()
	...
	ИначеЕсли ЭтоВыборКодаМаркировкиКегаНаОборудованииРозливаИСМП(ЭтотОбъект) Тогда
		...
		Если НайденныеСтроки.Количество() Тогда
			СтруктурыДанных.ДанныеВыбора.ПолныйКодМаркировки  = НайденныеСтроки[0].ПолныйКодМаркировки;
			СтруктурыДанных.ДанныеВыбора.ШтрихкодУпаковки     = НайденныеСтроки[0].КодМаркировки;
			СтруктурыДанных.ДанныеВыбора.Серия                = НайденныеСтроки[0].Серия;
		КонецЕсли;
	Иначе
