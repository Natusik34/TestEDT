...
Процедура ПечатьРегламентированногоОтчетаШтрих(Ссылка, Наименование)
	...
	Если Наименование = "6-НДФЛ (с 2021 года)" И ОписаниеРегОтчета(Ссылка).ВыбраннаяФорма = "ФормаОтчета2024Кв2" Тогда
		ПоказатьПредупреждение(, НСтр(
	...
	Если Наименование = "Расчет доли доходов личного фонда" Тогда
		ПоказатьПредупреждение(, НСтр(
		"ru='Печать со штрихкодом PDF417 формы
